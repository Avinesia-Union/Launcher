...
public final class ClientProfile implements Comparable<ClientProfile> {
    ...
    public enum Version {
        ...
        MC152("1.5.2", 61),
        MC164("1.6.4", 78),
        MC172("AvinesiaLauncher 1.7.2", 4),
	MC173("AvinesiaLauncher 1.7.3", 4),
	MC174("AvinesiaLauncher 1.7.4", 4),
	MC175("AvinesiaLauncher 1.7.5", 4),
	MC176("AvinesiaLauncher 1.7.6", 5),
	MC177("AvinesiaLauncher 1.7.7", 5),
	MC178("AvinesiaLauncher 1.7.8", 5),
	MC179("AvinesiaLauncher 1.7.9", 5),
	...
	MC186("AvinesiaLauncher 1.8.6", 47),
	MC187("AvinesiaLauncher 1.8.7", 47),
        MC188("AvinesiaLauncher 1.8.8", 47),
        MC189("AvinesiaLauncher 1.8.9", 47),
        MC19("AvinesiaLauncher 1.9", 107),
	MC191("AvinesiaLauncher 1.9.1", 108),
        MC192("AvinesiaLauncher 1.9.2", 109),
	MC193("AvinesiaLauncher 1.9.3", 110),
        MC194("AvinesiaLauncher 1.9.4", 110),
	MC110("AvinesiaLauncher 1.10", 210),
	MC1101("AvinesiaLauncher 1.10.1", 210),
        MC1102("AvinesiaLauncher 1.10.2", 210),
        MC111("AvinesiaLauncher 1.11", 315),
	MC1111("AvinesiaLauncher 1.11.1", 316),
        MC1112("AvinesiaLauncher 1.11.2", 316),
        MC112("AvinesiaLauncher 1.12", 335),
        MC1121("AvinesiaLauncher 1.12.1", 338),
        MC1122("AvinesiaLauncher 1.12.2", 340),
        MC113("AvinesiaLauncher 1.13", 393),
        MC1131("AvinesiaLauncher 1.13.1", 401),
        MC1132("AvinesiaLauncher 1.13.2", 402),
        MC114("AvinesiaLauncher 1.14", 477),
        MC1141("AvinesiaLauncher 1.14.1", 480),
        MC1142("AvinesiaLauncher 1.14.2", 485),
        MC1143("AvinesiaLauncher 1.14.3", 490),
        MC1144("AvinesiaLauncher 1.14.4", 498),
        MC115("AvinesiaLauncher 1.15", 573),
        MC1151("AvinesiaLauncher 1.15.1", 575),
        MC1152("AvinesiaLauncher 1.15.2", 578),
	MC116("AvinesiaLauncher 1.16", 735),
        MC1161("AvinesiaLauncher 1.16.1", 736),
        MC1162("AvinesiaLauncher 1.16.2", 751),
        MC1163("AvinesiaLauncher 1.16.3", 753),
        MC1164("AvinesiaLauncher 1.16.4", 754),
